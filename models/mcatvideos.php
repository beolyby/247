...

{
...

	{
		...
		$this->getdata(TBL_CATVIDEOS,$orderby,$limit);
	...
	function getalias($id){
		...
		$sql = 'select Id from '.TBL_CATVIDEOS.' where alias = "'.$id.'" order by Id desc limit 1';
	...
	function getaliasInc($id,$parent){
		...
		$sql = 'select Id from '.TBL_CATVIDEOS.' WHERE alias = "'.$id.'" AND parentid='.$parent.'  limit 1';
	...
	function getinfoAlias($id){
		...
		$sql = 'select * from '.TBL_CATVIDEOS.' where alias = "'.$id.'" order by Id desc limit 1';
