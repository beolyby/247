		...
		function TreeCatnews($pid,$data,$text="--"){
			...
			?>
				<tr>
					...
					<td align="left"><a href = '<?php echo BASE_URL_ADMIN;?>catnews/edit/<?php echo $item['Id'];?>' title = 'Sửa'><?php echo $text.$item['title_vn']; ?></a></td>
                    ...
                    <a href = '<?php echo BASE_URL_ADMIN;?>catnews/edit/<?php echo $item['Id'];?>' title = 'Sửa'><img src = '<?php echo ADMIN_PATH_IMG;?>b_edit.png'></a></td>
