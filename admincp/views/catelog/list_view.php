		...
		function TreeCatnews($pid,$data,$text=" __ "){
			...
			?>
				<tr>
					...
					<?php 
                    if($item['menu'] == "1"){
                        echo "<div id = 'menu".$item['Id']."'><a href = 'javascript: hideshow(\"".TBL_CATELOG."\",\"menu\",\"".$item['Id']."\",\"0\",\"menu".$item['Id']."\",\"".BASE_URL_ADMIN."\");' title = 'Bỏ khóa'><img src = '".ADMIN_PATH_IMG."icon-16-default.png'></a></div>";
                    }else{
                        echo "<div id = 'menu".$item['Id']."'><a href = 'javascript: hideshow(\"".TBL_CATELOG."\",\"menu\",\"".$item['Id']."\",\"1\",\"menu".$item['Id']."\",\"".BASE_URL_ADMIN."\");' title = 'Khóa tin'><img src = '".ADMIN_PATH_IMG."icon-16-nondefault.png'></a></div>"; 
                    }
                    ?>
                    </td>	
					<td align = 'center'>
