...
<div class="main_area">
    ...
    <td> Quản lý nội dung / Sửa chủ đề videos </td>
...
<form action = '<?php echo BASE_URL_ADMIN;?>catvideos/edit/<?php echo $data['info']['Id']?>' method = 'post' enctype = "multipart/form-data">
