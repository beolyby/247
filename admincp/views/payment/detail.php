...
<div class="main_area">
    ...
    <td> Quản lý Shop / Liên hệ / Chi tiết </td>
    </tr>
    </tbody>
    </table>
    </div>
...
<table>
    ...
    <tr>
		...
		<td><?php echo $data['cus']['address'];	
		?></td>
	</tr>
    <tr style="display: none;">
		<td class = 'title_td'>gọi lại lúc</td>
		<td><?php echo $data['cus']['goilai'];	
		?></td>
	</tr>
...
<td valign="top" style="text-align:left">
    ...
    Xác nhận đơn hàng
        ...
        <select name="tinhtrang">
            ...
            <option value="4" <?php if($data['cus']['status']==4 ) echo 'selected'; ?>>Hủy</option>
    	</select></p>
