		...
		if(!empty($data['info'])){
			...
			?>
				<tr>
					...
					<td>
						<?php 
						if($item['location'] == 2) echo 'Logo Trắng';
						if($item['location'] == 3) echo 'Sideshow';
						if($item['location'] == 4) echo 'Logo Đen';
						if($item['location'] == 5) echo 'Banner Home';
						if($item['location'] == 1) echo 'logo khách hàng';
						...
						if($item['location'] == 10) echo 'Liên hệ';
						if($item['location'] == 11) echo 'banner phải';
						?>
					</td>
