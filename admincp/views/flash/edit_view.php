...
<table>
	<tr>
		...
		<select name = "location">
			<option value = '2' <?php if($data['info']['location'] == 2) echo 'selected';?>>Logo Trắng</option>
             <option value = '4' <?php if($data['info']['location'] == 4) echo 'selected';?>>Logo Đen</option>
			<option value = '3' <?php if($data['info']['location'] == 3) echo 'selected';?>>Sideshow</option>
            <option value = '5'  <?php if($data['info']['location'] == 5) echo 'selected';?>>Banner Home</option>
            <option value = '1'  <?php if($data['info']['location'] == 1) echo 'selected';?>>Logo khách hàng</option>
            ...
            <option value = '10'  <?php if($data['info']['location'] == 10) echo 'selected';?>>Liên hệ</option>
            <option value = '11'  <?php if($data['info']['location'] == 11) echo 'selected';?>>banner phải</option>
		</select>
		</td>
	</tr>
	<tr>
    ...
    <tr>
		...
		<td><input type = 'text' name = 'title_<?php echo $vlang ?>' value="<?php echo $data['info']['title_'.$vlang];?>" size = '60'></td>
	</tr>
	<?php } ?>
	<tr>
