...
<a href = '<?php echo BASE_URL_ADMIN;?>catimages/add' class="button"><span class = 'them'> <?php echo G_ADD; ?></span></a>

</div>



<form action = '<?php echo BASE_URL_ADMIN;?>catimages/del' method = 'post'  name="rowsForm" id="rowsForm">
...
<a href="javascript:confirmSave('<?php echo JSM_DO_YOU_REALLY_WANT_TO_SAVE;?>','<?php echo BASE_URL_ADMIN;?>catimages/save')" class="button">Save</a>
