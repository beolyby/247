...
<div id="content-size">
<div id="header-logo">
      <div id="logo"><a href="/"><img alt="BIO NATURAL POOL - Hồ bơi sinh thái, thiết bị hồ bơi, xây dựng hồ bơi"  src="<?php echo PATH_IMG_FLASH.$data["logo"]['file_vn']?>"></a></div>
...
<div id="nav-size">
  <div id="nav">
     ...
     <div id="nav-menuhome2">
		...
		<?php 
		if(!empty($item['images'])) echo '<img alt="Thuong hieu" src="/data/Manufacturer/'.$item['images'].'" width="60" />';
