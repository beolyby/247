<div class="page-title-wrap" <?php if($data['adv']['file_vn']!=""){ ?>style="background-image:url(<?php echo PATH_IMG_FLASH.$data['adv']['file_vn'] ?>); color:#fff" <?php } ?>><div class="grid"><h1 class="page-entry-title "><?php echo $data['prod']['title_'.lang] ?></h1></div></div>
<div class="breadcrumbs"><div class="grid"><?php echo $data['map_title'] ?></div></div>
<div class="grid">
<div class="content">
<?php echo stripcslashes($data['prod']['content_'.lang]);?>
</div>
...
<a href="<?php echo PATH_IMG_WORKS.$item['images'] ?>" class="image-link"><img src="<?php echo PATH_IMG_WORKS.$item['images'] ?>" /></a>
</div>
<?php }} ?>
</div>
</div>
